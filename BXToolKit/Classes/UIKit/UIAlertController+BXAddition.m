//
//  UIAlertController+BXAddition.m
//  BXToolKit
//
...
@interface UIViewController (BX_Topmost)

- (UIViewController *)bx_topmost;

@end

@implementation UIViewController (BX_Topmost)
...
@implementation UIAlertController (BXAddition)
                            ...
                            tapBlock:(UIAlertControllerCompletionBlock)tapBlock
{
    ...
    [viewController.bx_topmost presentViewController:controller animated:YES completion:nil];
