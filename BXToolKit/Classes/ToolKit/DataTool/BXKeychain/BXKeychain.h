...
/**
 Error code specific to BXKeychain that can be returned in NSError objects.
 For codes returned by the operating system, refer to SecBase.h for your
 platform.
 */
typedef NS_ENUM(OSStatus, BXKeychainErrorCode) {
	/** Some of the arguments were invalid. */
	BXKeychainErrorBadArguments = -1001,
};

/** BXKeychain error domain */
extern NSString *const kBXKeychainErrorDomain;

/** Account name. */
extern NSString *const kBXKeychainAccountKey;
 ...
 */
extern NSString *const kBXKeychainCreatedAtKey;

/** Item class. */
extern NSString *const kBXKeychainClassKey;

/** Item description. */
extern NSString *const kBXKeychainDescriptionKey;

/** Item label. */
extern NSString *const kBXKeychainLabelKey;

/** Time the item was last modified.

 The value will be a string.
 */
extern NSString *const kBXKeychainLastModifiedKey;

/** Where the item was created. */
extern NSString *const kBXKeychainWhereKey;
...
/**
 ...
 BXKeychain has since switched to a simpler implementation that was abstracted from [SSToolkit](http://sstoolk.it).
 */
...
/**
 ...
 See the `NSString` constants declared in BXKeychain.h for a list of keys that can be used when accessing the
