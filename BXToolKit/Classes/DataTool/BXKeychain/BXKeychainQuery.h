...
NS_ASSUME_NONNULL_BEGIN
	...
	#define BXKeychain_SYNCHRONIZATION_AVAILABLE 1
#endif

#if __IPHONE_3_0 || __MAC_10_9
	// Keychain access group available at compile time
	#define BXKeychain_ACCESS_GROUP_AVAILABLE 1
#endif

#ifdef BXKeychain_SYNCHRONIZATION_AVAILABLE
typedef NS_ENUM(NSUInteger, BXKeychainQuerySynchronizationMode) {
	BXKeychainQuerySynchronizationModeAny,
	BXKeychainQuerySynchronizationModeNo,
	BXKeychainQuerySynchronizationModeYes
};
#endif
 ...
 */
@interface BXKeychainQuery : NSObject
...
@property (nonatomic) BXKeychainQuerySynchronizationMode synchronizationMode;
#endif
...
/**
 ...
 BXKeychain_SYNCHRONIZATION_AVAILABLE is only for compile time. If you are checking for the presence of synchronization,
